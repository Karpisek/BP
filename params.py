...
CORRIDORS_RANSAC_THRESHOLD = 100
CORRIDORS_STOP_LINE_OFFSET = 10
...
# tracker
TRACKER_OPTICAL_FLOW_FREQUENCY = 1  # 1
TRACKER_DISALLOWED = 10000
TRACKER_LIFELINE = 5
TRACKER_MINIMAL_SCORE = 0.5
TRACKER_SUPPRESSION_MIN = 0.5
TRACKER_MAX_OVERLAP = 0.1
TRACKER_TRAJECTORY_MIN_ANGLE = 30
TRACKER_TRAJECTORY_MAX_ANGLE = 150
TRACKER_HISTORY_DIFFERENCE = 20
...
UINT_MIN = -2147483648
UINT_MAX = 2147483647
RANDOM_COLOR = [(np.random.randint(20, 100), np.random.randint(20, 100), np.random.randint(20, 100)) for _ in range(100)]
