...
CALIBRATOR_LIFELINE_THICKNESS = 70
CALIBRATOR_VP2_TRACK_MAX_PER_RUN = 3

CALIBRATOR_BLUR_KERNEL = (3, 3)
CALIBRATOR_MEDIAN_BLUR_KERNEL_SIZE = 9
CALIBRATOR_FOCUS_AREA_COEFFICIENT = 1/3
CALIBRATOR_HORIZONTAL_PARTS = 3
CALIBRATOR_BASE_MIN_DISTANCE = 20

CALIBRATOR_HOUGH_MINIMAL_LINE_LENGTH = 50
CALIBRATOR_HOUGH_MAXIMAL_LINE_GAP = 30
CALIBRATOR_DILATATION_KERNEL = (5, 5)
