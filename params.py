...
CALIBRATOR_RANSAC_THRESHOLD_RATIO = 0.005   # ransac acceptance of point threshold 0.03 (o.O15)

CALIBRATOR_VP1_MINIMUM = 50          # not-used 300 (100)
...
CALIBRATOR_HORIZONTAL_PARTS = 2

CALIBRATOR_HOUGH_MINIMAL_LINE_LENGTH = 100
CALIBRATOR_HOUGH_MAXIMAL_LINE_GAP = 20
